defmodule RethinkDB.MigrationTest do
  ...
  test "create and drop table" do
    ...
    {:ok, %RethinkDB.Record{data: data}} = RethinkDB.Query.table_list |> TestRepo.run
  ...
  test "create and drop index" do
    ...
    {:ok, %RethinkDB.Record{data: data}} = RethinkDB.Query.table("test_table") |> RethinkDB.Query.index_list |> TestRepo.run
